...
* Déplacez le pointeur sur une zone de page (appelée zone cliquable) pour afficher une fenêtre contextuelle contenant des informations sur un élément.
* Cliquez sur une zone de page pour ouvrir une nouvelle page Web contenant plus d’informations sur un élément.
* rédiger un pense-bête et l’associer à une page du catalogue électronique ;
* Appuyez sur les icônes de zone cliquable si vous souhaitez lancer des pages Web connexes ou des panneaux d’informations contextuels.
...
![Catalogue électronique tel qu’il s’affiche pour les utilisateurs. A) Page d’ouverture du catalogue électronique. B)Le catalogue électronique est passé à la page 2.](/help/assets/ec_cat_viewer_popup.png)
...
Sur la page Catalogue électronique, dans l’onglet **[!UICONTROL Ordre des pages]**, sélectionnez une option Disposition : **[!UICONTROL 1 Up]**, **[!UICONTROL 2 Up]** ou **[!UICONTROL Custom]**. Vous pouvez réorganiser les pages ou les planches en les faisant glisser ou, dans le cas de catalogues électroniques volumineux, en choisissant un nom de page dans le menu Déplacer vers.

Pour ajouter des pages, sélectionnez un dossier dans la bibliothèque de fichiers, puis faites glisser les fichiers PDF ou d’images dans l’écran Ordre des pages. Au lieu de numéros de page par défaut, vous pouvez fournir des noms de page personnalisés ou importer de nombreux noms de page.
...
Pour créer une zone cliquable, ouvrez l’écran Catalogue électronique. Accédez ensuite à l’onglet **[!UICONTROL Pages de zones]** de l’écran Catalogue électronique, puis encadrez la zone à l’aide de l’outil Zone cliquable rectangulaire ou de l’outil Zone cliquable polygonale. Vous pouvez ajuster la position et la taille d’une zone cliquable en faisant glisser ses bordures à l’aide de l’outil Panoramique.

Une fois la zone cliquable créée, entrez l’adresse URL à laquelle vous souhaitez accéder lorsque vous cliquez sur la zone cliquable. Vous pouvez également indiquer le texte de survol qui s’affiche lorsque le pointeur se trouve sur la zone cliquable.
...
Après avoir marqué votre catalogue électronique et votre fichier PDF pour publication dans le panneau de navigation, cliquez sur le bouton Publier de la barre de navigation globale pour lancer une publication. Dans l’écran Publier, cliquez sur **[!UICONTROL Envoyer la publication]**.

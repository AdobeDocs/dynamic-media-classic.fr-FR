...
description: 'null'
seo-description: Découvrez les options de retouche d’images disponibles au moment du téléchargement.
...
* **Rognage basé sur la transparence** Indiquez 0 pour rogner les pixels uniquement s’ils sont entièrement transparents ; les valeurs plus proches de 1 permettent une plus grande transparence.
...
* **Personnalisé de > à** Ouvre les menus pour choisir un espace colorimétrique Convertir à partir de et Convertir en. Vous pouvez choisir un espace colorimétrique Photoshop standard ou un espace colorimétrique que vous avez téléchargé dans Dynamic Media Classic.

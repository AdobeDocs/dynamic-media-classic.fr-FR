...
Pour tirer le meilleur parti des fonctionnalités de zoom Dynamic Media Classic, préparez vos fichiers image de zoom avant de les télécharger :

* **Taille**  d’image : Dynamic Media Classic recommande d’utiliser des fichiers image dont la taille est, au minimum, de 2 000 pixels. ce afin d’obtenir des images clairement visibles lors de l’exécution d’un zoom.

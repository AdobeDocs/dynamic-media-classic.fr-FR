...
Le contenu créé par l’utilisateur consiste à charger des ressources dans un référentiel de stockage [!DNL Adobe Dynamic Media Classic] dédié et à effectuer les opérations associées.
...
Avant de charger des ressources, vous devez obtenir une clé secrète partagée. Cette clé vous permet de récupérer un jeton de téléchargement. Vous envoyez le jeton de téléchargement lorsque vous téléchargez des fichiers et réalisez d’autres tâches sur le contenu généré par l’utilisateur.

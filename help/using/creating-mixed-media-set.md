...
description: Découvrez comment créer un jeu de médias mixtes dans Adobe Dynamic Media Classic.
...
**Pour créer une visionneuse de médias mixtes, procédez comme suit**

1. Accédez à **[!UICONTROL Créer]** > **[!UICONTROL Visionneuses de médias mixtes]**.
...
Vous pouvez modifier une visionneuse de supports variés. Pour modifier une visionneuse contenue dans une visionneuse de supports variés, ouvrez-la séparément, modifiez-la, puis enregistrez-la. Les modifications apparaissent dans la visionneuse de médias mixtes.
...
1. Sélectionnez le bouton Survol de la visionneuse de médias mixtes **[!UICONTROL Modifier]**.
1. Utilisez l’une des méthodes suivantes :

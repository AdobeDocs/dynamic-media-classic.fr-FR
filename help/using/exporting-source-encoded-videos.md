...
Dans le panneau de navigation, les vidéos sources sont intitulées *Vidéo en Principal*. Les vidéos codées sont intitulées *Vidéo*. Vous pouvez exporter des vidéos principales et des vidéos codées. Pour exporter des fichiers vidéo, sélectionnez-les dans le panneau de navigation et accédez à **[!UICONTROL Fichier]** > **[!UICONTROL Exporter]**.

...
Les échantillons Adobe Dynamic Media Classic offrent aux utilisateurs une expérience de visionnage intégrée. Grâce à la visionneuse de jeux d’échantillons dynamiques, les utilisateurs peuvent voir un élément rendu dans une couleur, un matériau, une texture, une finition ou un tissu différent en sélectionnant une miniature.

Ce démarrage rapide des ensembles d’échantillons est conçu pour vous aider à commencer à utiliser les techniques des ensembles d’échantillons dans Adobe Dynamic Media Classic.
...
Sur la barre de navigation générale, sélectionnez **[!UICONTROL Télécharger]** pour télécharger des fichiers depuis votre ordinateur vers un dossier d’Adobe Dynamic Media Classic. Voir [Préparation du téléchargement d’un échantillon d’Assets](preparing-swatch-set-assets-upload.md#preparing-swatch-set-assets-for-upload) et [Téléchargement de vos fichiers](uploading-files.md#uploading-your-files).

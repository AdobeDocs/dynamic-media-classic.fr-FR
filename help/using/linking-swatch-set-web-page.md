---
title: Liaison d’un échantillon à une page web
description: Découvrez comment lier un échantillon à une page web dans Adobe Dynamic Media Classic.
...
# Liaison d’un échantillon à une page web{#linking-a-swatch-set-to-a-web-page}

Après avoir publié un ensemble d’échantillons, vous pouvez utiliser l’URL ou le code intégré qui lui est associé dans votre site web ou application. Vous pouvez ensuite déployer l’URL ou le code intégré selon les besoins afin que les utilisateurs puissent afficher l’ensemble d’échantillons sur votre site web ou application.

>[!NOTE]
>
>l’URL n’est activée qu’une fois le fichier publié.

## Copie d’une URL d’échantillon {#copying-a-swatch-set-url}

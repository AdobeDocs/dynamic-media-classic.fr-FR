...
description: En savoir plus sur les services de formation Adobe pour Adobe Dynamic Media Classic.
...
Dynamic Media Classic propose des formations sous forme de vidéos, d’ateliers animés par un instructeur, de sessions web et de démonstrations.
...
Voir [Services de formation Adobe](https://learning.adobe.com/)
...
La section Prise en main du système d’aide présente des instructions pour les utilisateurs qui découvrent Adobe Dynamic Media Classic. Il explique les principes de base du programme, de la navigation, de la configuration, de la gestion des ressources et de la création de contenu multimédia enrichi.

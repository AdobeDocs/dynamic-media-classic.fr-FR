...
* [API de diffusion et de rendu d’images](https://experienceleague.adobe.com/en/docs/dynamic-media-developer-resources)
...
* [Comment Adobe Dynamic Media Classic prend en charge le SEO ](/help/using/assets/s7_seo.pdf) : Adobe Dynamic Media Classic optimise les images pour les moteurs de recherche afin d’augmenter le trafic sur votre site web. Ce PDF fournit le contexte et les conseils de mise en œuvre pour atteindre ce résultat.
...
[vidéos de formation ](https://experienceleague.adobe.com/en/docs/dynamic-media-classic/using/intro/training-videos#intro).

Voir toutes les ressources populaires disponibles pour [](home.md).

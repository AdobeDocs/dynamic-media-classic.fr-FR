...
Les utilisateurs de l’outil de création d’images Adobe Dynamic Media Classic peuvent accéder aux vignettes (fichiers VNT), aux couvre-fenêtres (fichiers VNW) et aux armoires (fichiers VNC). Ces fichiers ne peuvent pas être créés ni modifiés dans Adobe Dynamic Media Classic.
...
Chargez les vignettes, les couvre-fenêtres et les armoires de la même manière que les autres fichiers.

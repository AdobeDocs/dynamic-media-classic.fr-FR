...
![Vue détaillée](/help/using/assets/image_0.img.png)
...
1. Dans le panneau de navigation, effectuez l’une des opérations suivantes :
   ...
   * Sélectionnez le fichier. Dans le coin supérieur droit d’Adobe Dynamic Media Classic, sélectionnez l’icône **[!UICONTROL Affichage des détails]**.

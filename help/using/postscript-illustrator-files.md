---
title: Utilisation des fichiers PostScript et Illustrator
...
# Utiliser des fichiers PostScript et Adobe Illustrator{#working-with-postscript-and-illustrator-files}
...
Lorsque vous téléchargez des fichiers image PostScript (EPS) ou Adobe Illustrator (AI), vous pouvez les configurer à l’aide de plusieurs options. Vous pouvez pixelliser les fichiers, les convertir au format FXG pour le module de publication à l’aide de modèles prédéfinis, conserver l’arrière-plan transparent, choisir une résolution et sélectionner un espace colorimétrique. Les options de formatage des fichiers PostScript et Adobe Illustrator sont disponibles dans l’écran de chargement sous Options PostScript et Options Adobe Illustrator dans la zone Charger les options de la tâche .

...
1. Pour créer votre modèle initial, utilisez l’une des méthodes suivantes :
   ...
   * **Sélectionner d’abord le PSD ou les images**: dans le panneau Parcourir, sélectionnez le fichier de PSD ou les images de votre modèle, accédez à la page **[!UICONTROL Build]** > **[!UICONTROL Concepts de base des modèles]**.
...
1. Spécifiez l’une des options de formatage suivantes, puis sélectionnez **[!UICONTROL Appliquer]**.
   ...
   * **[!UICONTROL Taille de police]**: sélectionnez une taille de police dans le menu, saisissez une taille spécifique dans la zone ou sélectionnez l’option **[!UICONTROL Monter]** ou **[!UICONTROL Descendre]** flèches permettant d&#39;augmenter ou de réduire la taille de deux points.

   * **[!UICONTROL Couleur]**: choisissez une couleur pour le texte.
...
1. Spécifiez l’une des options de formatage suivantes, puis sélectionnez **[!UICONTROL Appliquer]**.
   ...
   * **[!UICONTROL Retirer tout]**: sélectionnez cette option pour augmenter la mise en retrait du texte.
   ...
   * **[!UICONTROL Espace avant le paragraphe]**: spécifiez l’espace devant s’afficher au-dessus de la première ligne de texte du paragraphe.

   * **[!UICONTROL Espace après le paragraphe]**: spécifiez l’espace devant s’afficher sous la dernière ligne de texte du paragraphe.
...
1. Dans le panneau Propriétés du calque, sélectionnez l’une des options suivantes :
   ...
   * **[!UICONTROL Réduire le texte (Éditeur de texte v4.2 uniquement)]**: sélectionnez cette option pour réduire le texte afin qu’il s’insère dans la zone de texte.
   ...
   * **[!UICONTROL Aucun retour]**: n’encapsule pas le texte lorsque la zone de texte est trop petite horizontalement et coupe une partie du texte.
...
* **Saisie des mesures de la taille du calque**: renseignez les mesures en pixels dans les zones de texte W (Largeur) et H (Hauteur) de la zone Propriétés du calque.
...
* **Modification manuelle de la position**: déplacez le pointeur près d’une limite de calque, mais pas au-dessus de celle-ci. Lorsque vous voyez le curseur en flèche à quatre pointes, sélectionnez et commencez à faire glisser le curseur.
...
1. Sélectionnez la variable **[!UICONTROL `Add Effect`]** et choisissez une option :
   ...
   * **[!UICONTROL Luminosité interne]**: applique un effet d’éclat à l’intérieur des bords du calque.
...
* **[!UICONTROL Taille]**: renseignez les mesures dans les zones X et Y pour agrandir ou réduire l’effet d’ombre. Les options de taille ne sont disponibles que pour les ombres intérieures et les ombres portées.

* **[!UICONTROL Développer]**: faites glisser le curseur pour étendre l’effet vers l’intérieur ou l’extérieur.

* **[!UICONTROL Flou]**: faites glisser le curseur pour contrôler l’aplatissement aux bords de l’effet. Plus le degré de flou est élevé, plus les contours sont atténués.

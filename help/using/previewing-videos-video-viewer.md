...
1. Sélectionnez le lien **[!UICONTROL Aperçu]** afin de pouvoir examiner la ressource dans la visionneuse sélectionnée.
...
Dans les paramètres prédéfinis de visionneuse, vous pouvez activer, filtrer, trier et prévisualiser les paramètres prédéfinis de visionneuse.

Voir [Paramètres prédéfinis de la visionneuse](application-setup.md#viewer_presets).

Consultez également la section [Paramètres vidéo prédéfinis](https://s7d5.scene7.com/s7viewers/html5/VideoViewer.html?videoserverurl=https://s7d5.scene7.com/is/content/&emailurl=https://s7d5.scene7.com/s7/emailFriend&serverUrl=https://s7d5.scene7.com/is/image/&config=Scene7SharedAssets/Universal_HTML5_Video&contenturl=https://s7d5.scene7.com/skins/&asset=S7tutorials/549_video-presets_converted%20renamed_Done-AVS) vidéo de formation .

**Pour ajouter ou modifier un paramètre prédéfini de visionneuse de vidéos, procédez comme suit**
...
1. Dans le coin supérieur droit d’Adobe Dynamic Media Classic, accédez à **[!UICONTROL Configuration]** > **[!UICONTROL Paramètres prédéfinis de la visionneuse]**.
   ...
   Vous pouvez choisir de n’afficher que les paramètres prédéfinis de la visionneuse de vidéos. Dans la barre d’outils située directement au-dessus du tableau, sélectionnez Visionneuse de vidéos dans la liste déroulante des Visionneuses.

...
Vous pouvez utiliser la Liste des visionneuses pour prévisualiser l’affichage d’une ressource sur une plateforme particulière de type visionneuse, telle qu’HTML5. Selon le type de ressource et la visionneuse associée que vous avez sélectionnés pour la prévisualisation, toutes les plateformes ne sont pas disponibles dans la liste des visionneuses.
...
1. Dans le panneau Bibliothèque de ressources sur le côté gauche, accédez aux dossiers de ressources contenant la visionneuse à 360° que vous souhaitez prévisualiser dans une visionneuse.

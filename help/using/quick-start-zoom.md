...
Dans la barre de navigation globale, sélectionnez **[!UICONTROL Télécharger]** pour télécharger des images de votre ordinateur ou réseau vers un dossier sur Adobe Dynamic Media Classic. Voir [Téléchargement des images de zoom](uploading-zoom-images.md#uploading_zoom_images).
...
Pour créer une cible de zoom, sélectionnez **[!UICONTROL Modifier]** et choisissez Cibles de zoom, ou ouvrez une image dans le panneau Parcourir en mode Affichage des détails et sélectionnez **[!UICONTROL Cibles de zoom]**. Utilisez ensuite les outils de zoom de la page Éditeur de cible de zoom pour isoler une partie de l’image en tant que cible. Voir [Création de cibles de zoom pour un zoom guidé](creating-zoom-targets-guided-zoom.md#creating_zoom_targets_for_guided_zoom).
...
Pour explorer les différents paramètres prédéfinis de la visionneuse de zoom et la manière dont ils présentent l’expérience de zoom, sélectionnez une image dans le panneau Parcourir et sélectionnez **[!UICONTROL Aperçu]**. Accédez à **[!UICONTROL Paramètres prédéfinis]** > **[!UICONTROL Zoom]**, puis sélectionnez un paramètre prédéfini avec le menu Zoom.
...
Dans la barre de navigation globale, sélectionnez **[!UICONTROL Publish]**. Dans la boîte de dialogue Publication, sélectionnez **[!UICONTROL Submit Publish]**. (voir [Publication des images de zoom](publishing-zoom-images.md#publishing_zoom_images)).

## 6. Liaison des visionneuses de zoom à une page web

Adobe Dynamic Media Classic crée les chaînes d’légende URL nécessaires pour zoomer sur les images et les active lorsque vous publiez des images sur les serveurs d’images Dynamic Media. Vous pouvez copier ces chaînes URL à partir de la page **[!UICONTROL Preview]** . Une fois les chaînes d’URL copiées, elles sont disponibles sur vos sites Web et dans vos applications. Voir [Visionneuses de zoom de lien vers votre page web](linking-zoom-viewers-web-pages.md#linking_zoom_viewers_to_your_web_pages).

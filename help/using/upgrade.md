---
title: Mise à niveau d’ [!DNL Dynamic Media Classic] vers [!DNL Dynamic Media] on [!DNL Experience Manager] Assets
...
| --- | --- |
| Création et diffusion accélérées de contenu | · Collaboration et synchronisation de fichiers partagés avec les applications [!DNL Adobe Creative Cloud].<br>· Satisfait à tous les critères requis de la gestion dynamique des ressources : créer, collaborer, gérer et diffuser tout dans une seule application, une seule interface, un seul réseau.<br>· Gestion des ressources numériques à l’échelle de l’entreprise avec une prise en charge robuste des métadonnées, une recherche intelligente, des lightbox et des collections, un contrôle de version et un partage sécurisé des ressources à l’usage des fournisseurs, partenaires et franchisés<br>· Examen et approbation des workflows pour les ressources en cours de traitement. |
| Éléments de l’interface utilisateur des expériences interactives simples | · Créez facilement des expériences avec des créateurs en temps réel non techniques.<br>· Médias Shoppable/interactifs, combinez les ressources de la campagne aux informations sur les produits.<br>· Augmentez la satisfaction des clients et stimulez la conversion. |
| Workflow Inclusif De Bout En Bout | · Diffusez des contenus multimédias enrichis optimisés sur tous les points de contact, y compris les solutions [!DNL Adobe Experience Cloud] complètes.<br>· Intégration à [!DNL Adobe Experience Cloud] pour une analyse des ressources avancée, le ciblage et la réutilisation des ressources entre les points de contact marketing. Certains de ces points de contact incluent des [!DNL Adobe Campaign] pour les e-mails, des [!DNL Adobe Social] pour les canaux sociaux et des sites [!DNL Adobe Experience Manager] pour les applications web et mobiles réactives. |

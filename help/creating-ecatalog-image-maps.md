...
1. (Facultatif) Dans le panneau liste de zone cliquable, sous l’en-tête de colonne **[!UICONTROL Info-bulle]**, saisissez le texte que les utilisateurs doivent voir à l’écran lorsqu’ils déplacent le pointeur sur la zone cliquable.
1. Cliquez sur **[!UICONTROL Enregistrer]**.
...
* **Ajustement de la position**  : sélectionnez l&#39;outil Panoramique et déplacez le pointeur à proximité de la bordure de la carte, mais pas dessus. Lorsque le pointeur prend la forme d’une flèche à quatre pointes, faites glisser la zone de l’image entière vers un nouvel emplacement.
...
* **Copie de zones cliquables sur d’autres pages**  - Cliquez sur  **[!UICONTROL Copier des zones cliquables sur]**  (assurez-vous que l’onglet Pages de zones est actif). Dans l’écran Sélectionner les images, sélectionnez la ou les pages sur lesquelles vous souhaitez copier les zones cliquables, puis cliquez sur **[!UICONTROL Sélectionner]**.
...
1. En cas d&#39;erreur de texte de survol, cliquez sur l&#39;erreur dans la colonne **[!UICONTROL Erreur de texte de survol]** pour voir ce qui doit changer dans votre feuille de calcul pour corriger l&#39;erreur. Vous pouvez sélectionner et copier le texte contenu dans ce message et le coller dans la feuille de calcul.
1. Cliquez sur **[!UICONTROL Prévisualisation]** pour examiner une page dans la visionneuse de catalogue électronique, cliquez sur le X pour fermer l’écran Résumé et revenir à l’écran Pages de zones ou sur **[!UICONTROL Fermer]** pour revenir à la navigation.
...
Pour copier toutes les zones cliquables d’un catalogue électronique dans un autre, procédez comme suit :

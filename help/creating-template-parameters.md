...
1. Cliquez sur l’option **[!UICONTROL On]** en regard du nom de l’attribut text (textAttr).
1. Cliquez sur l’onglet **[!UICONTROL Texte]** dans l’écran Paramètres .
1. Cliquez sur **[!UICONTROL Ajouter un paramètre]**. Un nom de paramètre par défaut s’affiche. Pour remplacer ce nom, sélectionnez-le, puis saisissez un autre nom. La chaîne de texte courante devient le nouveau nom du paramètre.

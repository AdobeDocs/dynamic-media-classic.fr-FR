...
1. Utilisez l’une des méthodes suivantes pour commencer à créer votre catalogue électronique :
   ...
   * **Début de l’écran**  Catalogue électronique - Cliquez sur  **[!UICONTROL Créer]**  >  **[!UICONTROL Catalogues électroniques]**. Sélectionnez un dossier dans la bibliothèque de fichiers, puis faites glisser son contenu vers l’onglet Ordre des pages de la page Catalogue électronique.
...
1. Sélectionnez la disposition globale de votre catalogue électronique. Cliquez sur le bouton 1 vignette pour des pages simples, 2 vignettes pour des planches en double page ou Personnalisé pour des planches de plus de deux pages. La boîte de dialogue Modifier la disposition du catalogue électronique s’affiche. Sélectionnez l’option Toutes les planches, puis cliquez sur **[!UICONTROL OK]**.
1. Si vous le souhaitez, vous pouvez modifier la disposition des pages individuelles ou des planches en cliquant sur celles-ci, puis en cliquant sur **[!UICONTROL 1 Haut]**, **[!UICONTROL 2 Haut]** ou **[!UICONTROL Personnalisé]**. La boîte de dialogue Modifier la disposition du catalogue électronique s’affiche. Sélectionnez les options Feuilles sélectionnées, puis cliquez sur **[!UICONTROL OK]**.
1. Réorganisez les pages selon vos besoins en utilisant l’une des méthodes suivantes :
   ...
   * **Bouton**  Déplacer vers : sélectionnez une page ou une planche, cliquez sur  **[!UICONTROL Déplacer vers]**, puis choisissez la page du menu qui doit précéder la page.
